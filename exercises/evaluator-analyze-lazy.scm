...
(define (analyze exp)
    (cond ((self-evaluating? exp) (analyze-self-evaluating exp))
          ...
          ((assignment? exp) (analyze-assigment exp))
...
(define (analyze-assignment exp)
    (let ((var (assigment-variable exp))
          (vproc (analyze (assigment-value exp))))
        (lambda (env)
...
(define (delay-it proc env) (list 'thunk proc env))
...
(define (force-it obj)
    (cond ((thunk? obj)
           (let ((result (force-it ((thunk-proc obj) (thunk-env obj)))))
...
(define (list-of-arg-values exps)
    (if (no-operands? exps)
        '()
