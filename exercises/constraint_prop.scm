...
(define (inform-abount-no-value constraint) (constraint 'I-lost-my-value))
        ...
        (define (forget-my-value retractor)
            (if (eq? retractor informant)
                (begin (set! informant false)
                       (for-each-except retractor inform-abount-no-value constraints))
                'ignored))
...
; test
(define (celsius-fahrenheit-converter0 c f)
